...
def test_homepage_check_campaigns(context: BrowserContext):
    ...
    try:
        ...
        logging.debug("Login")
        page.get_by_role("button", name="Fai login").nth(1).click()
        page.get_by_label("Email*").click()
        page.get_by_label("Email*").fill("automation.vp.it@gmail.com")
        page.get_by_label("Password*").click()
        page.get_by_label("Password*").fill("@Ut0mati0n.es")
        page.get_by_role("button", name="Entra").click()
        logging.debug("End Login")
        logging.debug("Scrolling to end...")
        page.get_by_role("heading", name="I migliori brand scelti per te").click(button="right")
        page.keyboard.down('End')
        page.get_by_role("heading", name="LA NOSTRA SELEZIONE").click()
        page.keyboard.down('End')
        page.get_by_role("heading", name="LA NOSTRA SELEZIONE").click()
        page.keyboard.down('End')
        page.get_by_role("heading", name="NUOVE VENDITE").click()
        page.keyboard.down('End')
        page.get_by_role("heading", name="SEMPRE QUI PER TE").click()
        page.keyboard.down('End')
        page.get_by_role("heading", name="VENDITE IN CORSO").click()
        page.keyboard.down('End')
        page.get_by_role("heading", name="ULTIMO GIORNO").click()
        page.keyboard.down('End')
        page.get_by_role("heading", name="A BREVE").click()
        page.keyboard.down('End')
        page.locator(".footer__sc-6fue58-1 > div:nth-child(3)").click()
        page.locator(".footer__sc-35j76a-0").click()
        page.locator("div").filter(
            has_text="Su PrivaliaChi siamoCondizioni generali d'uso e venditaProtezione dei dati perso").nth(3).click()
        page.get_by_text("FacebookInstagramBlogLinkedInLe nostre applicazioniiOSAndroid").click()
...
def check_campaign_link_is_not_dead(context, campaigns_catalogs):
    error = 0
    success = 0
    vp_root_link = variables.vp_sites_map['PRIVALIA-IT']['vp_site_root_url']
        ...
        for campaign in campaigns_catalog:
            try:
                ...
                data = {
                    ...
                    "fail_level": "high",
                    "timestamp": timestamp,
                    "country": variables.vp_sites_map['PRIVALIA-IT']['country'],
