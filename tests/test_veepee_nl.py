...
def test_homepage_check_campaigns(context: BrowserContext):
    ...
    page.goto(variables.vp_sites_map["NL"]["vp_site_root_url"])
    ...
    page.get_by_label("Email*").fill("automation.vp.nl@mail.com")
    page.get_by_label("Wachtwoord*").click()
    page.get_by_label("Wachtwoord*").fill("@Ut0mati0n.es")
    page.get_by_role("button", name="Inloggen").click()

    page.get_by_role("heading", name="TOP MERKEN").click()
    page.keyboard.down('End')
    time.sleep(1)
    page.get_by_role("heading", name="NIEUW").click()
    page.keyboard.down('End')
    time.sleep(1)
    page.get_by_role("heading", name="HUIDIGE VERKOPEN").click()
    page.keyboard.down('End')
    time.sleep(1)
    page.get_by_role("heading", name="LAATSTE KANS").click()
    page.keyboard.down('End')
    time.sleep(1)
    page.get_by_role("heading", name="BINNENKORT").click()
    page.keyboard.down('End')
    time.sleep(1)
            ...
            try:
                ...
                if (
                    ...
                    with context.new_page() as page_camp:
                        ...
                        page_camp.wait_for_load_state('load')
                        page_camp.locator("head > title").text_content()
                ...
                context.tracing.stop(path="trace_" + timestamp + ".zip")
