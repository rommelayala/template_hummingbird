...
def test_homepage_check_campaigns(context: BrowserContext):
    ...
    page.goto(variables.vp_sites_map["LU"]["vp_site_root_url"])
    ...
    page.get_by_label("Email*").fill("automation.vp.lu@mail.com")
    page.get_by_label("Mot de passe*").click()
    page.get_by_label("Mot de passe*").fill("@Ut0mati0n.es")
    page.get_by_role("button", name="Se connecter").click()

    time.sleep(1)
    page.get_by_role("heading", name="VENTES INCONTOURNABLES").click()
    page.keyboard.down('End')
    time.sleep(1)
    page.get_by_role("heading", name="NOUVEAUTÉS").click()
    page.keyboard.down('End')
    time.sleep(1)
    page.get_by_role("heading", name="VENTES OUVERTES").click()
    page.keyboard.down('End')
    time.sleep(1)
    page.get_by_role("heading", name="DERNIÈRE CHANCE").click()
    page.keyboard.down('End')
    time.sleep(1)
    page.get_by_role("heading", name="À VENIR").click()
    page.keyboard.down('End')
    time.sleep(1)
